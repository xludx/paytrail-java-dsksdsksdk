...
public class TokenPaymentRequest {
  ...
  public TokenPaymentRequest stamp(String stamp) {
    this.stamp = stamp;
    return this;
  }
  ...
  **/
  ...
  public TokenPaymentRequest reference(String reference) {
  ...
  **/
  ...
  public TokenPaymentRequest amount(Long amount) {
    this.amount = amount;
    return this;
  }
  ...
  **/
  ...
  public TokenPaymentRequest currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public TokenPaymentRequest language(LanguageEnum language) {
  ...
  **/
  ...
  public TokenPaymentRequest orderId(String orderId) {
  ...
  **/
  ...
  public TokenPaymentRequest items(List<Item> items) {
    this.items = items;
    return this;
  }

  public TokenPaymentRequest addItemsItem(Item itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public TokenPaymentRequest customer(Customer customer) {
  ...
  **/
  ...
  public TokenPaymentRequest deliveryAddress(Address deliveryAddress) {
  ...
  **/
  ...
  public TokenPaymentRequest invoicingAddress(Address invoicingAddress) {
  ...
  **/
  ...
  public TokenPaymentRequest redirectUrls(Callbacks redirectUrls) {
  ...
  **/
  ...
  public TokenPaymentRequest callbackUrls(Callbacks callbackUrls) {
  ...
  **/
  ...
  public TokenPaymentRequest callbackDelay(Integer callbackDelay) {
  ...
  **/
  ...
  public TokenPaymentRequest token(String token) {
    this.token = token;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TokenPaymentRequest tokenPaymentRequest = (TokenPaymentRequest) o;
    return Objects.equals(this.stamp, tokenPaymentRequest.stamp) &&
        Objects.equals(this.reference, tokenPaymentRequest.reference) &&
        Objects.equals(this.amount, tokenPaymentRequest.amount) &&
        Objects.equals(this.currency, tokenPaymentRequest.currency) &&
        Objects.equals(this.language, tokenPaymentRequest.language) &&
        Objects.equals(this.orderId, tokenPaymentRequest.orderId) &&
        Objects.equals(this.items, tokenPaymentRequest.items) &&
        Objects.equals(this.customer, tokenPaymentRequest.customer) &&
        Objects.equals(this.deliveryAddress, tokenPaymentRequest.deliveryAddress) &&
        Objects.equals(this.invoicingAddress, tokenPaymentRequest.invoicingAddress) &&
        Objects.equals(this.redirectUrls, tokenPaymentRequest.redirectUrls) &&
        Objects.equals(this.callbackUrls, tokenPaymentRequest.callbackUrls) &&
        Objects.equals(this.callbackDelay, tokenPaymentRequest.callbackDelay) &&
        Objects.equals(this.token, tokenPaymentRequest.token);
  }

  @Override
  public int hashCode() {
    return Objects.hash(stamp, reference, amount, currency, language, orderId, items, customer, deliveryAddress, invoicingAddress, redirectUrls, callbackUrls, callbackDelay, token);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TokenPaymentRequest {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to TokenPaymentRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TokenPaymentRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TokenPaymentRequest is not found in the empty JSON string", TokenPaymentRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TokenPaymentRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TokenPaymentRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TokenPaymentRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TokenPaymentRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TokenPaymentRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TokenPaymentRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TokenPaymentRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<TokenPaymentRequest>() {
           @Override
           public void write(JsonWriter out, TokenPaymentRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TokenPaymentRequest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of TokenPaymentRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TokenPaymentRequest
  * @throws IOException if the JSON string is invalid with respect to TokenPaymentRequest
  */
  public static TokenPaymentRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TokenPaymentRequest.class);
  }

 /**
  * Convert an instance of TokenPaymentRequest to an JSON string
  *
  * @return JSON string
  */
