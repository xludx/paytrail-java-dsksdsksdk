...
public class PaymentReportBySettlementIdRequest {
  /**
  ...
  public PaymentReportBySettlementIdRequest() {
  }

  public PaymentReportBySettlementIdRequest requestType(RequestTypeEnum requestType) {
  ...
  **/
  ...
  public PaymentReportBySettlementIdRequest callbackUrl(String callbackUrl) {
  ...
  **/
  ...
  public PaymentReportBySettlementIdRequest reportFields(List<ReportFieldsEnum> reportFields) {
    this.reportFields = reportFields;
    return this;
  }

  public PaymentReportBySettlementIdRequest addReportFieldsItem(ReportFieldsEnum reportFieldsItem) {
  ...
  **/
  ...
  public PaymentReportBySettlementIdRequest submerchant(Integer submerchant) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PaymentReportBySettlementIdRequest paymentReportBySettlementIdRequest = (PaymentReportBySettlementIdRequest) o;
    return Objects.equals(this.requestType, paymentReportBySettlementIdRequest.requestType) &&
        Objects.equals(this.callbackUrl, paymentReportBySettlementIdRequest.callbackUrl) &&
        Objects.equals(this.reportFields, paymentReportBySettlementIdRequest.reportFields) &&
        Objects.equals(this.submerchant, paymentReportBySettlementIdRequest.submerchant);
  }

  @Override
  public int hashCode() {
    return Objects.hash(requestType, callbackUrl, reportFields, submerchant);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PaymentReportBySettlementIdRequest {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to PaymentReportBySettlementIdRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentReportBySettlementIdRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentReportBySettlementIdRequest is not found in the empty JSON string", PaymentReportBySettlementIdRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaymentReportBySettlementIdRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentReportBySettlementIdRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PaymentReportBySettlementIdRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentReportBySettlementIdRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentReportBySettlementIdRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentReportBySettlementIdRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentReportBySettlementIdRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentReportBySettlementIdRequest>() {
           @Override
           public void write(JsonWriter out, PaymentReportBySettlementIdRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaymentReportBySettlementIdRequest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PaymentReportBySettlementIdRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PaymentReportBySettlementIdRequest
  * @throws IOException if the JSON string is invalid with respect to PaymentReportBySettlementIdRequest
  */
  public static PaymentReportBySettlementIdRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentReportBySettlementIdRequest.class);
  }

 /**
  * Convert an instance of PaymentReportBySettlementIdRequest to an JSON string
  *
  * @return JSON string
  */
